...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
     ...
     <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          @else
            Silahkan Login
          @endif
          <img class="img-circle elevation-2" src="{{ url('public')}}/assets-admin/dist/img/akun.jpeg" alt="User Image" style="width: 30px; height: 30px;">
        </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ url('public') }}/assets-admin/dist/img/keranjang.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ url('public') }}/assets-admin/dist/img/akun.jpeg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">
            @if(Auth::check())
              {{request()->user()->username}}
           @else
           <a href="{{('login_admin')}}">Silahkan Login</a>
          @endif
          </a>
        </div>
      </div>
